...
const Widget = (props: AllWidgetProps<IMConfig>) => {
  ...
  if (vistaActiva !== undefined) {
    contenidoRenderizado = (
      <>
        <TextArea placeholder='Url del Servicio Feature Layer' onChange={inputHandler}/>
        <Button type='primary' onClick={buttonHandler}>Añadir Capa</Button>
      </>
    )
  }
